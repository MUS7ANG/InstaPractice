        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-md">
                <div className="bg-white border border-gray-200 rounded p-8 mb-4">
                    ...
                    <form className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full py-2 pl-10 pr-3 border border-gray-300 rounded bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    {/* Facebook Login */}
                    <button
                        className="w-full flex items-center justify-center text-blue-900 font-semibold my-4"
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-xs text-gray-500">© 2025 Instagram from Meta</p>
                </div>
            </div>
        </div>
    );
