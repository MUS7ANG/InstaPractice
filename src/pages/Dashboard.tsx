...
import { Heart, MessageCircle, Bookmark, Send, MoreHorizontal, Home, Search, PlusSquare, Film, User } from 'lucide-react';
import '../index.css';
...
const Dashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            {/* Main Content */}
            <main className="flex-grow max-w-xl mx-auto w-full bg-gray-50 pt-4 pb-16">
                {/* Stories */}
                ...
                {/* Post */}
                <article className="bg-white border border-gray-300 rounded mb-4">
                    {/* Post Header */}
                    <div className="flex items-center p-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-yellow-400 to-pink-500 p-0.5 mr-3">
                            <div className="bg-white rounded-full p-0.5 w-full h-full">
                                <img
                                    src="/women.jpeg"
                                    alt="User profile"
                        ...
                        <div className="flex-grow">
                            <p className="font-semibold text-sm">nature_photography</p>
                            <p className="text-xs text-gray-500">Mountain View, California</p>
                        </div>
                        <button>
                    ...
                    <div className="p-3">
                        ...
                        {/* Likes */}
                        <p className="font-semibold text-sm mb-1">{liked ? "1,235 likes" : "1,234 likes"}</p>

                        {/* Caption */}
                        <p className="text-sm mb-1">
                            <span className="font-semibold">nature_photography</span> Breathtaking sunset view from the mountain top!
                            The colors were absolutely amazing this evening. Nature never ceases to amaze me.
                            #nature #photography #sunset #mountains
                        </p>

                        {/* View all comments */}
                        <p className="text-sm text-gray-500 mb-1">View all 87 comments</p>

                        {/* Comments */}
                        <div className="text-sm mb-2">
                            <p>
                                <span className="font-semibold">travel_enthusiast</span> Wow, this is stunning! Which mountain is this?
                            </p>
                            <p>
                                <span className="font-semibold">photo_lover</span> The colors are amazing! Great shot! 📸
                            </p>
                        </div>

                        {/* Timestamp */}
                        <p className="text-xs text-gray-500 uppercase mb-2">12 hours ago</p>

                        {/* Add Comment */}
                        <form onSubmit={handleCommentSubmit} className="flex items-center mt-2 border-t pt-3">
                            <input
                                type="text"
                ...
                <article className="bg-white border border-gray-300 rounded mb-4">
                    <div className="flex items-center p-3">
                        ...
                        <div className="flex-grow">
                            <p className="font-semibold text-sm">travel_enthusiast</p>
                    ...
                    <div className="p-3">
                        ...
                        <p className="font-semibold text-sm mb-1">2,461 likes</p>
                        <p className="text-sm mb-1">
                            <span className="font-semibold">travel_enthusiast</span> Beautiful day exploring Paris!
                            #travel #paris #vacation
                        </p>
                        <p className="text-xs text-gray-500 uppercase mb-2">1 day ago</p>
                    </div>
                </article>
            </main>

            {/* Bottom Navigation */}
            <nav className="bg-white border-t border-gray-300 fixed bottom-0 w-full">
